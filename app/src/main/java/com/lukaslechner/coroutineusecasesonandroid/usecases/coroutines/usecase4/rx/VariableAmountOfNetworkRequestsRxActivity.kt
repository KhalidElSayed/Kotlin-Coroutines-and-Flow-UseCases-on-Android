...
class VariableAmountOfNetworkRequestsRxActivity : BaseActivity() {
    ...
    private val viewModel: VariableAmountOfNetworkRequestsRxViewModel by viewModels()
    ...
    private fun onLoad() = with(binding) {
        operationStartTime = java.lang.System.currentTimeMillis()
    ...
    private fun onSuccess(uiState: UiState.Success) = with(binding) {
        enableButtons()
        progressBar.setGone()
        val duration = java.lang.System.currentTimeMillis() - operationStartTime
        textViewDuration.text = getString(com.lukaslechner.coroutineusecasesonandroid.R.string.duration, duration)
